...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference('Rating.count') do
      post ratings_url, params: { rating: { comment: @rating.comment, score: @rating.score } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { comment: @rating.comment, score: @rating.score } }
